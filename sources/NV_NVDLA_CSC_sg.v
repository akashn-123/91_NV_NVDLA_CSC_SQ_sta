...
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
    if (!nvdla_core_rstn)
        ...
        // Register the signal that triggers the height counter
        h_cnt_inc_q <= op_do_h_en; 
end
//==========================================================================================//
...
always @(
  ...
  or is_last_block
    ...
    op_channel_en = pkg_adv_q & is_last_block;
end
...
always @(
  ...
  or is_last_channel
    ...
    op_stripe_en = pkg_adv_q & is_last_block & is_last_channel;
end
...
always @(
  ...
  or is_last_stripe
    ...
    op_do_h_en = is_img_d1 & pkg_adv_q & is_last_block & is_last_channel & is_last_stripe;
end
...
always @(
  ...
  or is_last_do_h
    ...
    op_group_en = pkg_adv_q & is_last_block & is_last_channel & is_last_stripe & is_last_do_h;
end
...
always @(
  ...
  or is_last_group
    ...
    op_layer_en = pkg_adv_q & is_last_block & is_last_channel & is_last_stripe & is_last_do_h & is_last_group;
end
...
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
  ...
  if ((layer_st | pkg_adv_q) == 1'b1) begin
    pkg_idx <= pkg_idx_w;
  // VCS coverage off
  end else if ((layer_st | pkg_adv_q) == 1'b0) begin
  end else begin
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_63x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(layer_st | pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
  ...
  if ((pkg_adv_q) == 1'b1) begin
    dat_pkg_w_offset <= weight_s_up_cnt;
  // VCS coverage off
  end else if ((pkg_adv_q) == 1'b0) begin
  end else begin
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_64x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_65x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_66x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_67x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_68x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_69x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_70x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_71x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_72x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_73x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_74x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_75x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_76x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
`ifndef SYNTHESIS
  // VCS coverage off 
  nv_assert_no_x #(0,1,0,"No X's allowed on control signals")      zzz_assert_no_x_77x (nvdla_core_clk, `ASSERT_RESET, 1'd1,  (^(pkg_adv_q))); // spyglass disable W504 SelfDeterminedExpr-ML 
  // VCS coverage on
`endif
`undef ASSERT_RESET
`endif // ASSERT_ON
...
//==========================pipelined==============================//
reg is_dat_greater_q; 

// 2. STAGE 1: The Comparison (Cycle N)
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
    if (!nvdla_core_rstn) begin
        is_dat_greater_q <= 1'b0;
    end else begin
        // The "Heavy" math happens here
        is_dat_greater_q <= (dat_max_cycles >= {1'b0, wt_max_cycles});
    end
end

// 3. STAGE 2: The Selection and Output (Cycle N+1)
always @(posedge nvdla_core_clk or negedge nvdla_core_rstn) begin
    if (!nvdla_core_rstn) begin
        max_cycles_q <= 6'b0;
        {mon_max_cycles, max_cycles} <= 7'b0;
    end else begin
        // Use the pre-calculated bit. This path is now very fast!
        if (is_dat_greater_q) begin
            {mon_max_cycles, max_cycles} <= dat_max_cycles - 1'b1;
        end else begin
        ...
        if (is_dat_greater_q) begin
             ...
             max_cycles_q <= wt_max_cycles - 1'b1;
        end
    end
end
//================================================================//
...
always @(
  ...
  or pop_cnt_dec
     ...
     pop_cnt_w = (dat_pop_ready | wt_pop_ready) ? max_cycles_q :
                 (pop_cnt == 6'h0) ? 6'h0 :
                 pop_cnt_dec;
end
...
always @(
  ...
  or dat_stripe_size
    ...
    dat_impact_cnt = (is_winograd_d1 & is_int8_d2) ? {dat_stripe_size[5:0], 3'b0} :
                     (is_winograd_d1 & ~is_int8_d2) ? {1'b0, dat_stripe_size[5:0], 2'b0} :
                     (~is_winograd_d1 & is_int8_d2) ? {1'b0, dat_stripe_size, 1'b0} :
...
always @(
  ...
  or reg2dp_skip_data_rls
    ...
    dat_release = pkg_adv_q & pkg_layer_end_w & ~reg2dp_skip_data_rls;
end
...
always @(
  ...
  or pkg_group_end_w
    ...
    wt_release = pkg_adv_q & ~reg2dp_skip_weight_rls & pkg_group_end_w;
end
